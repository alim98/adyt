...
def get_args_parser():
    ...
    parser.add_argument('--dynamic_tanh', type=str2bool, default=False,
                        help="Replace LayerNorm with DynamicTanh")
    parser.add_argument('--adaptive_dynamic_tanh', type=str2bool, default=False,
                        help="Replace LayerNorm with AdaptiveDynamicTanh")
    ...
    parser.add_argument('--smooth_factor', type=float, default=0.9,
                        help="Smoothing factor for gradient norm in AdaptiveDynamicTanh")
...
def main(args):
    ...
    elif args.adaptive_dynamic_tanh:
        from dynamic_tanh_adaptive import convert_ln_to_adyt
        model = convert_ln_to_adyt(model, 
                                  lambda_factor=args.lambda_factor,
                                  smooth_factor=args.smooth_factor)
        print(f"Using AdaptiveDynamicTanh with lambda={args.lambda_factor}, smooth_factor={args.smooth_factor}")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            use_amp=args.use_amp, use_adyt=args.adaptive_dynamic_tanh
        )
